...
public class MainController {
	...
	public String user(@RequestParam(value = "userId", required = false) Long userId, Model model) {
	...
	public String deleteUser(@RequestParam(value = "userId", required = true) Long userId, Model model) {
